...
const CommandInput = React.forwardRef(({ className, ...props }, ref) => (
    <div className='flex items-center border-b px-3' cmdk-input-wrapper=''>
        ...
        <CommandPrimitive.Input ref={ref} className={cn('flex h-10 w-full rounded-md border-none bg-transparent py-3 text-sm outline-none !ring-0 placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50', className)} {...props} />
    </div>
));
